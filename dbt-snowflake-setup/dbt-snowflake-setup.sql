...
CREATE OR REPLACE SCHEMA "DBT_DEV_DB"."DBT_SNOWFLAKE";
...
GRANT ALL ON SCHEMA "DBT_DEV_DB"."DBT_SNOWFLAKE" TO DBT_ROLE;
...
SHOW GRANTS ON SCHEMA "DBT_DEV_DB"."DBT_SNOWFLAKE";
SHOW GRANTS TO USER DBT_USER;

-----------------------------------------------------
-- For Open Metadata Catalog
-----------------------------------------------------
GRANT USAGE ON DATABASE DBT_DEV_DB TO ROLE DBT_ROLE;
GRANT USAGE ON SCHEMA DBT_DEV_DB.DBT_SNOWFLAKE TO ROLE DBT_ROLE;
GRANT USAGE ON WAREHOUSE DBT_WH TO ROLE DBT_ROLE;
